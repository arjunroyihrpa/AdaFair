...
import boosting_cost as boosting
#import boosting
...
class boostingMarginAnalyzer(marginAnalyzer):
   def __init__(self, data, protectedIndex, protectedValue, 
                weakLearner=DecisionTreeClassifier(),numRounds=20):
      self.splitData(data)
      _, self.hypotheses, self.alphas = boosting.detailedBoost(
         self.trainingData,weakLearner, protectedIndex, protectedValue,numRounds=numRounds)
